  ...
  stages {
    stage('Git Information') {
      ...
      steps {
        ...
        script {
          def myLib = new linuxacademy.get.gitStuff();
    ...
    stage('Running on CentOS') {
      ...
      steps {
        sh "wget http://dnbooth1.mylabserver.com/rectangles/all/${env.BRANCH_NAME}/rectangle_${env.MAJOR_VERSION}.${env.BUILD_NUMBER}.jar"
